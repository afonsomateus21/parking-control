...
public class ParkingSpotController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Object> getOneSparkingSpot(@PathVariable(value = "id") UUID id) {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Object> deleteSparkingSpot(@PathVariable(value = "id") UUID id) {
		Optional<ParkingSpotModel> parkingSpotModelOptional = parkingSpotService.findById(id);
